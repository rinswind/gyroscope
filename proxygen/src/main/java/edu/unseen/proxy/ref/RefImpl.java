...
public class RefImpl<A, V> implements Ref<A, V> {
   ...
   * 
   * @see edu.unseen.proxy.ref.Ref#val()
   */
  public final A arg() {
    switch (state.state) {
    case BOUND:
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#attributes()
   */
  ...
  /**
   * @see edu.unseen.proxy.gen.Proxy#addListener(com.prosyst.mprm.backend.autowire.ServiceProxyListener)
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#removeListener(edu.unseen.proxy.ref.RefListener)
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#state()
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#lock()
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#bind(java.lang.Object, java.util.Map)
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#update(java.lang.Object, java.util.Map)
   */
  ...
  /**
   * @see edu.unseen.proxy.ref.Ref#unbind()
   */
